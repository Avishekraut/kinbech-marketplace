  ...
  return (
    <>
      ...
      <div className="w-[400px] border border-[#e0e3e4] rounded-sm px-7 py-10">
        ...
        <button className="py-2 rounded bg-[#14ae5c] text-white text-lg font-medium hover:bg-[#009951] active:scale-[.98] active:duration-75 transition-all ease-in-out ">Create Account</button>
        ...
        <p className="mt-4 text-center hover:text-slate-600 cursor-pointer">Already have account? Log In</p>
      </div>
      </div>
    </>
  );
